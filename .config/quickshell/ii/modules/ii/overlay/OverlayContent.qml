...
Item {
    ...
    WidgetCanvas {
        ...
        OverlayTaskbar {
            visible: !OverlayContext.notesOnly
            anchors {
        ...
        Repeater {
            model: ScriptModel {
                values: OverlayContext.notesOnly
                    ? [OverlayContext.availableWidgets.find(w => w.identifier === "notes")]
                    : Persistent.states.overlay.open.map(identifier => {
