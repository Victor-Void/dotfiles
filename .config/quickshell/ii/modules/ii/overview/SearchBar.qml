...
RowLayout {
    ...
    IconToolbarButton {
        ...
        background: MaterialShape {
            shape: clearClipboardButton.down ? MaterialShape.Shape.Square : MaterialShape.Shape.Circle
            color: clearClipboardButton.hovered ? Appearance.colors.colSurfaceContainerHigh : ColorUtils.transparentize(Appearance.colors.colSurfaceContainerHigh)
            Behavior on color {
