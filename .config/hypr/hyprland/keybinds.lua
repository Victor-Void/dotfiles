...
hl.bind("SUPER + Comma", hl.dsp.global("quickshell:overlayNotesToggle"), { description = "Shell: Toggle notes widget" })
...
hl.bind("SUPER + O", hl.dsp.exec_cmd(heliosApp), { description = "App: Helios ASUS Control" })
